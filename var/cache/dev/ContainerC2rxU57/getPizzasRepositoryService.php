 ...
 */
class getPizzasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PizzasRepository' shared autowired service.
     *
     * @return \App\Repository\PizzasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PizzasRepository.php';

        return $container->privates['App\\Repository\\PizzasRepository'] = new \App\Repository\PizzasRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
